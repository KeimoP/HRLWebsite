...
<body>
    ...
    <div class="jumbotron">
        <div class="container text-center">
            ...
            <a href="#teenused" class="btn btn-primary btn-lg px-4 me-2">
        ...
        <form method="POST">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="service" name="service">
                    ...
                    <option value="Multilift veod">Multilift veod</option>
                    <option value="Treilerveod">Treilerveod</option>
                    <option value="Fekaalivedu">Fekaalivedu</option>
                    <option value="Konteinerite rent ja prügivedu">Konteinerite rent ja prügivedu</option>
                    <option value="Täitematerjali müük ja vedu">Täitematerjali müük ja vedu</option>
                    <option value="Kaevandusteenus">Kaevandusteenus</option>
                    <option value="Laaduriteenus (5t)">Laaduriteenus (5t)</option>
                    <option value="Laaduriteenus (15t)">Laaduriteenus (15t)</option>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-3 mb-md-0">
                    <h5><i class="fas fa-truck-moving me-2"></i>HRL Veoteenused</h5>
                    <p class="mb-0 mt-2">Professionaalsed veoteenused alates 2010. aastast</p>
                </div>
                <div class="col-md-6 text-md-end">
                    <p class="mb-0">&copy; 2025 HRL. Kõik õigused kaitstud.</p>
                </div>
            </div>
        </div>
    </footer>
